...
export const DocUploadModal: React.FC<Props> = ({ competencies, onClose, onSuccess }) => {
  ...
  const handleGenerate = async () => {
    ...
    setError('');
    try {
      const res = await generateQuizFromDoc(file, compId, numQ, diff, quizTitle, targetRole, isDiagnostic);
      ...
      <div className="bg-white rounded-2xl max-w-xl w-full p-8 shadow-2xl relative">
        ...
        <div className="space-y-4 mb-8">
          <div>
            ...
            <input 
              type="text" 
              placeholder="e.g. DSA Array Fundamentals"
              value={quizTitle} 
          ...
          <div className="flex gap-4">
            ...
            <div className="flex gap-4 items-center">
              <div className="flex-1">
                ...
                <select value={targetRole} onChange={e => setTargetRole(e.target.value)} className="w-full border-gray-300 rounded-lg p-2.5 border">
              ...
              <div className="flex-1 flex items-center gap-2 mt-6">
                ...
                />
                <label htmlFor="diagnosticCheck" className="text-sm font-medium text-gray-700">
                  Is Diagnostic Baseline
                </label>
              </div>
            </div>
          </div>
